...
public class OutputElementFilterRule extends OrderedRule {
    ...
    public OutputElementFilterRule(Annotation annotation, int order,
                                   Class<? extends Filter> type, String name, String[] args, boolean keepOrder) {
