...
public class JsonEzSentinelRuleConfigurerForSpring4 implements EzSentinelRuleConfigurer<String> {
    ...
    protected EzSentinelRuleConfigurer<String> createConfigurer(){
        if (isEnabled()) {
            try {
                EzSentinelRuleConfigurer<String> configurer = (EzSentinelRuleConfigurer<String>) Class.forName("com.github.shepherdviolet.glacimon.spring.helper.sentinel.JsonEzSentinelRuleConfigurer").newInstance();
