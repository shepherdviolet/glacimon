...
public class HourlyTempFileBucketTest {

    private static final String ROOT_DIR = "./glacispring-common/build/temp-bucket-test-hourly";
    private static final String DATE_DIR_PREFIX = "tmp-";

    private static final DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd-HH").withZone(ZoneId.systemDefault());

    public static void main(String[] args) throws IOException, ParseException {

        HourlyTempFileBucket tempFileBucket = new HourlyTempFileBucket(ROOT_DIR, 4, DATE_DIR_PREFIX);
        ...
        createTempFile(getDateString(-5), "5.txt");
