...
/**
 * <p>字段输入规则: 使用过滤器对Map或Collection字段的元素进行过滤, 不影响Map的Key.</p>
 *
 * <p>输入类型及输出类型:</p>
 *
 * <pre>
...
@Repeatable(InputElementFilter.InputElementFilters.class)
public @interface InputElementFilter {
