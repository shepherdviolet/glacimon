...
public class ReflectUtils {
    ...
    public static MethodCaller getMethodCaller(Set<String> equalSkips, Collection<String> startsWithSkips) {
        com.github.shepherdviolet.glacimon.java.reflect.MethodCaller info = com.github.shepherdviolet.glacimon.java.reflect.MethodCaller.getMethodCaller(equalSkips, startsWithSkips, DEFAULT_SKIP_ELEMENTS);
    ...
    public static class MethodCaller {
        ...
        private MethodCaller(com.github.shepherdviolet.glacimon.java.reflect.MethodCaller info){
