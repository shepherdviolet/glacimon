...
/**
 * <p>过滤器: 将Map转换为List, 取value作为元素</p>
 *
 * <p>示例</p>
 * <pre>
 *     转换: @...Filter(type = MapValuesToList.class)
 * </pre>
 *
 * @author shepherdviolet
 */
@ImplementationName("MapValuesToList")
public final class MapValuesToList implements Filter, ExceptionFactoryAware {
    ...
    public Object doFilter(Object element, String[] args, RuleInfo ruleInfo) {
        ...
        return new ArrayList<>(((Map<?, ?>) element).values());
    }
